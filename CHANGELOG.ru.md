...
- **Russian CHANGELOG entry** for v0.15.1 — the bilingual `CHANGELOG.ru.md` file was last synced at v0.14.x. This release adds the v0.15.0, v0.15.1, and v0.15.2 entries in Russian.
