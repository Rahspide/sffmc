...
//
// MCP — INHERIT resolver logic. Two pure functions that translate the
// `ToolWhitelist` value on `agent()` opts into the resolved shape the
// SDK consumes. Extracted from mcp.ts to keep that file a barrel.
