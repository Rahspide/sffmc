...
//
// MCP bridge — public type definitions and budget constants.
// Pure types/constants: zero runtime dependencies (type-only imports).
//
// Module map:
//   ./mcp-types.ts      — types, constants (this file)
//   ./mcp-resolver.ts   — INHERIT resolver logic (discoverParentTools, resolveInheritedTools)
//   ./mcp-bridge.ts     — McpBridge class + makeMcpPrimitives host-side wrappers
//   ./mcp.ts            — barrel re-exporting the public API
