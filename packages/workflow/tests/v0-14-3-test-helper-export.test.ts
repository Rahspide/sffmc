...
// importable from `@sffmc/workflow/src/constants.ts` by any consumer that
// knew the path.
//
// Fix shape:
...
describe("v0.14.3 D-1: __setWorkflowConfig test escape hatch migration", () => {
  ...
  test("__setWorkflowConfig is no longer exported from @sffmc/workflow/src/constants.ts", async () => {
