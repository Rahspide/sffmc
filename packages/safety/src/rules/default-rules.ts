// Default rules YAML — extracted from index.ts to keep that file lean.
// This is the fallback used when ~/.config/SFFMC/rules.yaml is missing or invalid.
// Edit this file (NOT index.ts) to change default rules.
